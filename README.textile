...
__*Important for IOS4*: after adding @-fobjc-arc@ compiler flag to @SVPullToRefresh.m@, add @-fobjc-arc@ in Build Settings > Other Linker Flags. (http://stackoverflow.com/questions/8112035/libobjc-a-dylib-compile-error-on-ios-4-3)
